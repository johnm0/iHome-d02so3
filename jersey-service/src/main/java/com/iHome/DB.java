...
public class DB {
    ...
    private final String dbName = "ismgroup70";
    private final String dbusername = "ismgroup70";
    private final String dbpassword = "fpqs2f";
    ...
    /**
     * A method to get the Connection object (in order to execute sql
     * statements).
     *
     * @return Connection
     */
    ...
    /**
     * Establishes a connection with the database and initializes Connection
     * (con) object.
     *
     * @throws SQLException
     */
    public void open() throws SQLException {
        ...
        try {
            ...
            // establish a connection with the database and initializes the
            // Connection object (con)
            con = DriverManager.getConnection("jdbc:mysql://" + dbServerAddress + ":" + dbServerPort + "/" + dbName,
